Exercise 1
Suppose you're tasked with creating a program that takes a list of numbers and returns the sum of all the even numbers in the list. You'll need to create a function called sum_even_numbers() that takes a list of numbers as input and returns the sum of all the even numbers in the list.



To ensure that your function works correctly, you want to use test-driven development (TDD) to write tests for the function before you write the function itself. You've written test cases that checks if the function correctly sums up all even numbers in a list:
